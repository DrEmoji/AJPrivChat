...
- **Custom Emojis** added (thanks to ThatOneHam!) can be sent by sending custom keywords into private chat which can be found from https://raw.githubusercontent.com/DrEmoji/AJPrivChat/refs/heads/main/Emojis/Alias.json
