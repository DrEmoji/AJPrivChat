package gui
{
   ...
   public class GuiHud extends MovieClip
   {
      ...
      {
         var privateChatBtn:MovieClip;
         var purpleTint:ColorTransform;
         ...
         if(chatBar != null && sendChatBtn != null)
         {
            sendChatBtn.scaleX = 0.75;
            sendChatBtn.scaleY = 1;
            privateChatBtn = new sendChatBtn.constructor() as MovieClip;
            privateChatBtn.name = "privateChatBtn";
            privateChatBtn.scaleX = 0.75;
            privateChatBtn.scaleY = 1;
            privateChatBtn.filters = [];
            privateChatBtn.x = sendChatBtn.x + 30;
            privateChatBtn.y = sendChatBtn.y;
            purpleTint = new ColorTransform(1,0.8,1.2,1,20,0,60,0);
            privateChatBtn.transform.colorTransform = purpleTint;
            chatBar.addChild(privateChatBtn);
            privateChatBtn.addEventListener(MouseEvent.CLICK,function(e:MouseEvent):void
            {
               if(chatTxt)
               {
